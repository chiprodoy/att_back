...
@section('header')
    <h1 class="m-0">Tambah Attendance Log</h1>
@endsection
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="datetime-local" name="checklog_time" class="form-control" value="{{ old('checklog_time') }}">
                        @error('checklog_time') <div class="text-danger">{{ $message }}</div> @enderror
                    </div>
                    <div class="form-group">
                        <label>Shift In</label>
                        <input type="datetime-local" name="shift_in" class="form-control" value="{{ old('shift_in') }}">
                        @error('shift_in') <div class="text-danger">{{ $message }}</div> @enderror
                    </div>
                    <div class="form-group">
                        <label>Shift Out</label>
                        <input type="datetime-local" name="shift_out" class="form-control" value="{{ old('shift_out') }}">
                        @error('shift_out') <div class="text-danger">{{ $message }}</div> @enderror
                    </div>
                    <div class="form-group">
                        <label>Checkin Time 1</label>
                        <input type="datetime-local" name="checkin_time1" class="form-control" value="{{ old('checkin_time1') }}">
                        @error('checkin_time1') <div class="text-danger">{{ $message }}</div> @enderror
                    </div>
                    <div class="form-group">
                        <label>Checkin Time 2</label>
                        <input type="datetime-local" name="checkin_time2" class="form-control" value="{{ old('checkin_time2') }}">
                        @error('checkin_time2') <div class="text-danger">{{ $message }}</div> @enderror
                    </div>
                    <div class="form-group">
                        <label>Checkout Time 1</label>
                        <input type="datetime-local" name="checkout_time1" class="form-control" value="{{ old('checkout_time1') }}">
                        @error('checkout_time1') <div class="text-danger">{{ $message }}</div> @enderror
                    </div>
                    <div class="form-group">
                        <label>Checkout Time 2</label>
                        <input type="datetime-local" name="checkout_time2" class="form-control" value="{{ old('checkout_time2') }}">
                        @error('checkout_time2') <div class="text-danger">{{ $message }}</div> @enderror
                    </div>
                    <div class="form-group">
                        <label>Check Type</label>
                        <input type="number" name="check_type" class="form-control" value="{{ old('check_type') }}">
                        @error('check_type') <div class="text-danger">{{ $message }}</div> @enderror
                    </div>
                    <div class="form-group">
                        <label>Late Tolerance</label>
                        <input type="number" name="late_tolerance" class="form-control" value="{{ old('late_tolerance') }}">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="number" name="early_tolerance" class="form-control" value="{{ old('early_tolerance') }}">
                        @error('early_tolerance') <div class="text-danger">{{ $message }}</div> @enderror
                    </div>
                    <div class="form-group">
                        <label>Sdays</label>
                        <input type="number" name="sdays" class="form-control" value="{{ old('sdays') }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="early_checkin" class="form-control" value="{{ old('early_checkin') }}">
                        @error('early_checkin') <div class="text-danger">{{ $message }}</div> @enderror
                    </div>
                    <div class="form-group">
                        <label>Overtime</label>
                        <input type="number" name="overtime" class="form-control" value="{{ old('overtime') }}">
                        @error('overtime') <div class="text-danger">{{ $message }}</div> @enderror
                    </div>
                    <div class="form-group">
                        <label>Early Checkout</label>
                        <input type="number" name="early_checkout" class="form-control" value="{{ old('early_checkout') }}">
                        @error('early_checkout') <div class="text-danger">{{ $message }}</div> @enderror
                    </div>
                    <div class="form-group">
                        <label>Check Log Status</label>
                        <input type="number" name="check_log_status" class="form-control" value="{{ old('check_log_status') }}">
                        @error('check_log_status') <div class="text-danger">{{ $message }}</div> @enderror
                    </div>
                    <div class="form-group">
                        <label>Departement Name</label>
                        <input type="text" name="departement_name" class="form-control" value="{{ old('departement_name') }}">
